  ...
  if ( ! function_exists( 'thachpham_theme_setup' ) ) {
        ...
        function thachpham_theme_setup() {
          ...
          register_nav_menu ( 'primary-menu', __('Primary Menu', 'thachpham') );
					register_nav_menu ( 'primary-menu2', __('Primary Menu2', 'thachpham') );
					...
					*/
					...
					//    'id' => 'main-sidebar',
					//    'description' => 'Main sidebar for onliva theme',
					//    'class' => 'main-sidebar',
        ...
        */
        ...
        function theme_slug_widgets_init() {
          register_sidebar( array(
             'name' => __('Main Sidebar haa', 'thachpham'),
             'id' => 'main-sidebare',
             'description' => 'Main sidebar for onliva theme',
             'class' => 'main-sidebar',
             'before_title' => '<h3 class="widgettitle">',
...
if ( ! function_exists( 'thachpham_logo' ) ) {
	function thachpham_logo() {?>
		<div class="logo">
			...
			<div class="site-description">hehe <?php bloginfo( 'description' ); ?></div>
  ...
  function thachpham_entry_meta() {
    if ( ! is_page() ) :
      echo '<div class="entry-meta">';
        ...
        printf( __('<span class="author">Posted by <a href="%1$s">%2$s</a></span>', 'thachpham'),
...
if ( ! function_exists( 'thachpham_entry_tag' ) ) {
  function thachpham_entry_tag() {
    if ( has_tag() ) :
      ...
      printf( __('Tagged in %1$s', 'thachpham'),
         get_the_tag_list( '', ', ' ) );
      echo '</div>';
    endif;
  }
